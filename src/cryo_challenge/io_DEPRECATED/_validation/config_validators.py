...
def validate_config_mtm_data_submission(config_data_submission: dict) -> None:
    ...
    path_to_submission_file: str, is the path to the submission file (submission_*.pt).
...
def validate_config_mtm_data(config_data: dict) -> None:
    ...
    box_size: int, is the number of pixels in each dimension of the volume.
    voxel_size: float, is the pixel size of the volume in Angstroms.
...
def validate_input_config_disttodist(config: dict) -> None:
    ...
    input_path_to_submission_file: str, is the path to the map to map distance matrix (output from map2map_pipeline).
    metrics: list, is a list of metrics to compute.
    gt_metadata_path_to_submission_file: str, is the path to the ground truth metadata (.csv) file.
